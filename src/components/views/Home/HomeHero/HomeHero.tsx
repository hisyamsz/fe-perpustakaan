...
const HomeHero: React.FC<HomeHeroProps> = () => {
  ...
  return (
    <section className="bg-auth relative flex h-[500px] w-full bg-cover bg-center pt-12 md:pt-20">
      <div className="to-accent/30 absolute inset-0 bg-linear-to-r from-sky-800/80 via-cyan-400/30" />

      <div className="relative z-10 flex max-w-[800px] flex-col items-start gap-6 px-6 text-start text-white">
        <div className="flex flex-col gap-2">
          <h2 className="text-3xl font-bold drop-shadow-lg md:text-4xl lg:text-5xl">
